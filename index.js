    ...
    .defines(function () {
        EntityGameControl = ig.Entity.extend({
            ...
            UnlockCellClick: function () {
                ...
                {
                    if (ig.input.mouse.x >= 210 && ig.input.mouse.x <= 312) {
                        if (ig.input.mouse.y >= 157 && ig.input.mouse.y <= 214) {
                            ig.input.mouse.x = 0;
                            ig.input.mouse.y = 0;
                            if (this.isUnlockCell == 0) {
                                this.isUnlockCell = 1;
            ...
            Dragon2ndClickCall: function () {
                //console.log(ig.input.mouse.x + ' ' + ig.input.mouse.y);
                if (MJS.view.viewport.orientation.portrait) {
                    if (ig.input.mouse.x >= 176 && ig.input.mouse.x <= 379) {
                        if (ig.input.mouse.y >= 278 && ig.input.mouse.y <= 422) {
                            ig.input.mouse.x = 0;
                            ig.input.mouse.y = 0;
